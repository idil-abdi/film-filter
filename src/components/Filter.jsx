...
function Filter({ searchTerm, setSearchTerm, setQuery}) {
  ...
  return (
    <div className="py-5 w-full flex justify-center">
        <div className="flex w-full mx-10 lg:mx-60 flex-col gap-4 bg-[#12182e] border border-[#302456] p-4 rounded-xl">
            <form className="flex flex-wrap flex-col gap-4">
                    <div>
                        ...
                        <TextInput id="search" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} type="text" placeholder="🔍 Search" required />
                    </div>
