...
function Filter() {
  return (
    <div className="py-5 w-full flex justify-center">
        <div className="flex w-full mx-10 sm:w-2/3 flex-col gap-4 bg-[#12182e] border border-[#302456] p-4 rounded-xl">
            <form className="flex max-w-100 mx-5 flex-wrap flex-col gap-4">
                <div>
                    ...
                    <TextInput id="search" type="text" placeholder="🔍 Search" required />
                </div>
                <div>
                    <Select id="types">
                        <option>Types</option>
